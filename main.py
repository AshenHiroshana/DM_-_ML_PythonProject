...
data.drop([2, 8, 13, 22, 56, 154, 185, 186, 206, 209, 228, 236, 245, 258, 260, 317, 319, 359, 360, 399, 408, 425, 427,
           440, 489, 498, 545, 546, 549, 561, 579, 595, 604, 606, 622, 661, 675, 715, 748,753, 759], inplace=True)

data.drop([43, 84, 106, 177, 207, 362, 369, 658, 662, 672], inplace=True)

data.drop([7, 15, 18, 49, 60, 78, 81, 125, 172, 193, 222, 261, 266, 269, 300, 332, 336, 347, 426, 430, 435, 453, 468,
           484, 494, 522, 533, 535, 589, 597, 599, 601, 619, 643, 697, 703, 706], inplace=True)

data.drop([53, 54, 73, 111, 139, 144, 153, 162, 199, 215, 220, 231, 247, 248, 254, 279, 286, 296, 335, 364, 370, 375,
           388, 392, 395, 409, 412, 415, 480, 486, 487, 519, 574, 584, 608, 612, 645, 655, 679, 695, 707, 710, 713], inplace=True)

data.drop([9, 33, 50, 68, 90, 145, 239, 316, 371, 418, 438, 526, 607, 639, 684], inplace=True)
data.drop([4, 16, 41, 45, 57, 58, 59, 67, 92, 99, 120, 126, 155, 173, 178, 201, 211, 213, 229, 230, 235, 237, 270, 275,
           287, 292, 293, 303, 328, 350, 354, 378, 379, 387, 391, 405, 420, 422, 424, 428, 445, 469, 470, 485, 531, 532,
           558, 577, 580, 590, 596, 623, 638, 673, 681, 682, 689, 699, 712, 732, 740, 746, 747, 761], inplace=True)

data.drop([12, 39, 100, 131, 147, 152, 187, 218, 243, 259, 267, 308, 314, 330, 383, 416, 434, 458, 464, 493, 534, 588,
           593, 618, 621, 657, 659, 750, 755], inplace=True)

data.drop([115, 123, 129, 148, 221, 223, 263, 294, 361, 363, 456, 459, 479, 495, 509, 537, 552, 582, 666, 674, 763], inplace=True)

data.drop([11, 14, 40, 110, 130, 132, 175, 212, 227, 238, 283, 306, 327, 339, 355, 404, 506, 515, 548, 598,
           611, 646, 647, 660, 670, 696, 702, 708, 716, 728, 749], inplace=True)
